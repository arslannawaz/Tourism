        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="dashboard-list-box margin-top-0">
                    <h4>Dublin Attracive Points</h4>
                    <ul>

                        <?php
                        $sql = "SELECT * from attractive_points order by id desc";
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                <li>
                                    <div class="list-box-listing">
                                        <div class="list-box-listing-img"><a href="#"><img src="<?php echo 'includes/'.$file?>" alt=""></a></div>
                                    ...
                                    <div class="buttons-to-right">
                                        <a href="editplace.php?id=<?php echo $id; ?>" class="button gray">Edit</a>
                                        <a href="includes/deleteplace.php?id=<?php echo $id; ?>" class="button gray"><i class="sl sl-icon-close"></i> Delete</a>
                                    </div>
                                </li>
